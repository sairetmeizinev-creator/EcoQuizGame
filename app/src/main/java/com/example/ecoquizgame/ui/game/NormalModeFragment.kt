...
class NormalModeFragment : Fragment(R.layout.fragment_game) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.uiState.collect { state ->
                ...
                binding.livesText.text = getString(R.string.lives_format, "\u2764".repeat(state.lives))
    ...
    private fun showGameOverDialog(score: Int) {
        ...
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setNegativeButton(R.string.main_menu) { _, _ ->
                findNavController().navigate(R.id.action_normalModeFragment_to_mainMenuFragment)
            }
            .show()
    }
